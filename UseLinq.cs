                ...
                do
                {
                    ...
                    switch (selection.ToUpper())
                    {
                        case ("S"): //ColumnQuery = null; break;  // use linq logic here to assign the proper query
                                    // example
                            ColumnQuery = from e in Part2.EmployeesList.Emplist orderby e.stateCode select e; break;

                        case ("N"):// ColumnQuery = null; break;  // use linq logic here to assign the proper query
                                   // example
                            ColumnQuery = from e in Part2.EmployeesList.Emplist orderby e.Name select e; break;

                        case ("I"): ColumnQuery = from e in Part2.EmployeesList.Emplist orderby e.ID select e; break;//use linq logic here to assign the proper query

                        case ("P"): ColumnQuery = from e in Part2.EmployeesList.Emplist orderby e.YearlyPay select e; break;// ColumnQuery = null; break;  // use linq logic here to assign the proper query
                        case ("T"): ColumnQuery = from e in Part2.EmployeesList.Emplist orderby e.TotalTax select e; break; // ColumnQuery = null; break;  // use linq logic here to assign the proper query
